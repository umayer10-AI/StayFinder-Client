      ...
      <div className="flex min-h-[80vh] items-center justify-center px-4">
        <div className="w-full max-w-lg rounded-2xl border border-yellow-500/20 bg-zinc-900 p-8 text-center shadow-xl">
          ...
          <p className="mt-3 text-zinc-400">
            Free users can add up to <span className="font-semibold text-white">2 hotels</span>.
          ...
          <form action="/api/subscription" method="POST">
            <button type="submit"
            className="mt-6 inline-flex w-full items-center cursor-pointer justify-center rounded-xl bg-yellow-500 px-5 py-3 font-semibold text-black transition hover:bg-yellow-400"
          >
            Upgrade Now
          </button>
          </form>
